...
| Coordinated disclosures filed | **6** (1 vendor-declined + community fix PR unmerged; 1 maintainer-confirmed unmaintained; 4 awaiting maintainer response with 2026-08-10 embargo) |
