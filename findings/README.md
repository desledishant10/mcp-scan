...
| Outcome | Count |
|---|---|
| Vulnerability — vendor-declined (disclosure closed as "not planned"; community fix PR unmerged) | 1 |
...
|---|---|---|---|---|---|
| 2026-05-11 | MCP-D-003 fetch direct | `mcp-server-fetch` v2025.4.7 | SSRF → cloud metadata exfil | 🔴 **Disclosure closed as "not planned" (~2026-08-01); community fix PR unmerged; latest release still vulnerable** — PR [modelcontextprotocol/servers#4226](https://github.com/modelcontextprotocol/servers/pull/4226) by `@kgarg2468` (CI green 16/16, external review by `@LuuOW`, branch verified 2026-05-22 EC2 demo + 2026-06-20 containerized `poc/ssrf/` harness) remains open + unmerged. Disclosure consolidated to dormant umbrella issue [#3741](https://github.com/modelcontextprotocol/servers/issues/3741). Latest PyPI release `mcp-server-fetch==2026.6.4` still vulnerable | [2026-05-11-MCP-D-003-fetch-direct-environment-dependent-ssrf.md](2026-05-11-MCP-D-003-fetch-direct-environment-dependent-ssrf.md) |
